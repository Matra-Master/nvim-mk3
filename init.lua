...
require('lazy').setup({
  ...
  { -- Autocompletion
    ...
    config = function()
      ...
      cmp.setup {
        ...
        sources = {
          { name = 'path' }, -- It appears to fail but I don't know why
          {
            name = 'lazydev',
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc', 'dockerfile', 'hyprlang' },
